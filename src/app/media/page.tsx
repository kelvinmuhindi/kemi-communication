...
export const metadata = {
  title: "Media | Kemi Communications Ltd",
  description:
    "News, announcements and updates from Kemi Communications Ltd.",
};
      ...
      <main>
        ...
        <section id="news" className="px-6 py-[90px]">
          <div className="mx-auto max-w-[1240px]">
            ...
            <h2 className="mb-10 font-display text-2xl leading-tight text-brand-ink sm:text-[28px]">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {mediaItems.map((item) => (
                ...
                >
                  ...
                  <h3 className="mb-2 text-[17px] font-semibold text-brand-ink">
                    {item.title}
                  </h3>
                  <p className="mb-3 text-sm leading-relaxed text-brand-steel">
                    {item.excerpt}
                  </p>
        ...
        <section id="blog" className="bg-brand-paper-warm px-6 py-[90px]">
          <div className="mx-auto max-w-[1240px] text-center">
            ...
            <h2 className="mb-3 font-display text-2xl leading-tight text-brand-ink sm:text-[28px]">
